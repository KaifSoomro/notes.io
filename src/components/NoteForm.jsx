      ...
      <form onSubmit={handleSubmit} className='w-[430px] md:w-[550px] h-[370px] bg-amber-100 rounded-md pt-5 relative text-neutral-950'>
        ...
        <div className='w-full flex items-center justify-between'>
          ...
          <div className='w-full h-10 flex gap-3 md:gap-5 justify-end pe-7'>
            <div onClick={() => setColor("bg-teal-500")} className='w-10 h-10 bg-teal-500 rounded-full cursor-pointer'></div>
            <div onClick={() => setColor("bg-yellow-500")} className='w-10 h-10 bg-yellow-500 rounded-full cursor-pointer'></div>
            <div onClick={() => setColor("bg-pink-500")} className='w-10 h-10 bg-pink-500 rounded-full cursor-pointer'></div>
            <div onClick={() => setColor("bg-neutral-500")} className='w-10 h-10 bg-neutral-500 rounded-full cursor-pointer'></div>
            <div onClick={() => setColor("bg-lime-500")} className='w-10 h-10 bg-lime-500 rounded-full cursor-pointer'></div>
          </div>
        </div>
      </form>
    </div>
